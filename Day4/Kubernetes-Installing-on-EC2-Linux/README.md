...
>
> ```bash
> # Swap a usb extern (3.7 GB): # mmr ytm
...
```bash
sudo kubeadm init --apiserver-advertise-address=172.31.72.112 --pod-network-cidr=10.244.0.0/16
```

```bash
kubeadm join 172.31.72.112:6443 --token 00yyg2.q68yz3ewo8o00kav \   --discovery-token-ca-cert-hash sha256:96320d872758f52dd2eb4b88ae824479df2a90743b60d20e6ac09bedfb0f47b9
```
